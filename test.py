from src.llm_calls import call_ollama, js, create_function_call, call_openai
import json
import dotenv
import os
dotenv.load_dotenv()
...
response_msg, response, nr_tokens = call_openai(model_name, txt, custom_function, temperature, 1024)
